...
$(document).ready(function(){
  $('[data-rateable=true]').starRating({
    initialRating: $('.score').data('initrate'),
    ...
    onHover: function(currentIndex, currentRating, $el){
      $('.score__value--live').text(currentIndex);
      $('.score__notice--live').text($('.score').data('notice')[currentIndex]);
    },
    onLeave: function(currentIndex, currentRating, $el){
      $('.score__value--live').text(Math.floor(currentRating));
      $('.score__notice--live').text($('.score').data('notice')[Math.floor(currentRating)]);
    },
    callback: function(currentRating, $el){
      // do something after rating
    }
  });
  $('[data-rateable=false]').starRating({
    initialRating: 3.39,
    disableAfterRate: false,
    useFullStars: true,
    starSize: 30,
